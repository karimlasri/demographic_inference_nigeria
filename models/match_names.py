...
if __name__=='__main__':
    ...
    ## Name matching for unlabeled user profiles
    # Load user profiles    
    ...
    user_profiles.to_csv('data/all_users_with_demographics.csv')
    ...
    scores_test = score('ethnicity', names_mapping, labeled_profiles, gender_df)